...
{    
    ...
    // Getting user input for the aforedeclared values using std::cin. 
    ...
    // Passing the user input to the RoutePlanner object in order to perform search and render results.
