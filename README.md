...
### [YouTube Demonstration](https://youtu.be/IxK0O4NdZ6U?si=7UMSe2IirpEF9_pK)

## Description

his C++ project leverages OpenStreetMap data to construct an A* route planner, reminiscent of commercial navigation tools like Google Maps, enabling the identification and visualization of the shortest path between user-defined points (x, y) on an IO2D-powered map.

<img src="map.jpeg" width="800" height="450" />

# User Guide

Here are the steps for the user to go about the project:

## Cloning

When cloning this project, be sure to use the `--recurse-submodules` flag. Using HTTPS:
```
git clone https://github.com/m-abdulah-malik/Route-Planner.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:m-abdulah-malik/Route-Planner.git --recurse-submodules
```
...
## Troubleshooting
* In case you will encounter some issues, make sure you have downloaded [this](https://github.com/cpp-io2d/P0267_RefImpl/blob/master/BUILDING.md#xcode-and-libc).
